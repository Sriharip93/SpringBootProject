            ...
            <div class="card-body">
                <form action="addItem" method="post" >
                    ...
                    <fieldset class="form-group">
                        <label>Item Category</label> <input type="text" class="form-control" name="itemCategory" required="required">
                    </fieldset>
                   <fieldset class="form-group">
                        <label>Item Category Short Code</label> <input type="text" class="form-control" name="itemCategoryShortCode" required="required">
                    </fieldset>
                 <fieldset class="form-group">
                        <label>Description</label> <input type="text" class="form-control" name="description" required="required">
                    </fieldset>
